...
async function main() {
  ...
  const contract = StickyMan.attach(
    "0xfDdF940B30929c2C5825607c7439f73B7FFb753c"
  );
  ...
  const tx = await contract.mintWithMetadata(
    ...
    JSON.stringify({
      ...
      image:
        "https://bafybeibe7fghstg3zo2egbmp7vdxoxkaxo4bguxonktmqmlazrrdckw2ki.ipfs.dweb.link",
    }),
    8
  );
  await tx.wait();
