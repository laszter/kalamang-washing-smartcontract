...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IKAP721Interface extends Interface {
    getFunction(nameOrSignature: "adminTransfer" | "approve" | "balanceOf" | "externalTransfer" | "getApproved" | "internalTransfer" | "isApprovedForAll" | "ownerOf" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "transferFrom"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface IKAP721 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IKAP721;
    waitForDeployment(): Promise<this>;

    interface: IKAP721Interface;
