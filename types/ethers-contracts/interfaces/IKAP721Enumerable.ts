...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IKAP721EnumerableInterface extends Interface {
    getFunction(nameOrSignature: "tokenByIndex" | "tokenOfOwnerByIndex" | "totalSupply"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'totalSupply', data: BytesLike): Result;
  ...
  export interface IKAP721Enumerable extends BaseContract {
    
    connect(runner?: ContractRunner | null): IKAP721Enumerable;
    waitForDeployment(): Promise<this>;

    interface: IKAP721EnumerableInterface;
