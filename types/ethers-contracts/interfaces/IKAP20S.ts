...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IKAP20SInterface extends Interface {
    getFunction(nameOrSignature: "balanceOf" | "burn" | "decimals" | "mint" | "name" | "symbol" | "totalSupply" | "transferFrom"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface IKAP20S extends BaseContract {
    
    connect(runner?: ContractRunner | null): IKAP20S;
    waitForDeployment(): Promise<this>;

    interface: IKAP20SInterface;
